...
const WASM_CANONICAL_WORDING: Record<string, boolean> = {
  ...
  "arrays/leading-comma-illegal.vl": true,
  "arrays/trailing-comma-illegal.vl": true,
  "bitwise/float-reject.vl": true,
  "functions/inferred-return-soundness.vl": true,
  "functions/named-args-unknown.vl": true,
  "functions/trailing-comma-illegal.vl": true,
  "generics/array-element-correlation.vl": true,
  "generics/return-correlation.vl": true,
  "generics/type-alias-soundness.vl": true,
  "intrinsics/error-array-copy-not-list.vl": true,
  "intrinsics/error-array-new-arity.vl": true,
  "intrinsics/error-array-new-bad-length.vl": true,
  "intrinsics/error-trap-args.vl": true,
  "loops/for-in-not-array.vl": true,
  "objects/self-method-pollution.vl": true,
  "operators/eq-no-union-mismatch.vl": true,
  "soundness/arith-annotated-mismatch.vl": true,
  "soundness/equality-cross-type-reject.vl": true,
  "soundness/equality-type-mismatch.vl": true,
  "soundness/not-is-guard-no-divergence-no-narrow.vl": true,
  "soundness/struct-union-unshared-field-reject.vl": true,
  "types/assign-type.vl": true,
  "types/boolean-literal-to-i32-reject.vl": true,
  "types/boolean-to-i32-reject.vl": true,
  "types/condition-type.vl": true,
  "types/fn-arg-count.vl": true,
