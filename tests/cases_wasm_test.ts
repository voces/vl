...
const EXPECTED_DIVERGENCES: Record<string, string> = {
  ...
  "arrays/render-i32-array.vl": TS_WORDING,
  ...
  "generics/type-alias-bare-error.vl": TS_WORDING,
  ...
  "sets/error-infer-conflict.vl": TS_WORDING,
  "soundness/README.vl":
  ...
  "soundness/exhaustive-is-chain-no-else-reject.vl": TS_WORDING,
  "soundness/exhaustive-missing-is-case.vl": TS_WORDING,
  "soundness/exhaustive-missing-literal-case.vl": TS_WORDING,
  "soundness/function-arg-type-reject.vl": TS_WORDING,
  "soundness/intersection-param-reject.vl": TS_WORDING,
  "soundness/is-non-variant-reject.vl": TS_WORDING,
  "soundness/is-not-variant-of-union-reject.vl": TS_WORDING,
  "soundness/literal-union-reject-arg.vl": TS_WORDING,
  "soundness/literal-union-reject-assign.vl": TS_WORDING,
  "soundness/literal-union-reject-non-member.vl": TS_WORDING,
  "soundness/narrowing-and-else-not-narrowed.vl": TS_WORDING,
  "soundness/narrowing-then-only-no-leak.vl": TS_WORDING,
  "soundness/not-is-guard-no-divergence-no-narrow.vl": TS_WORDING,
  "soundness/nullable-access-nested.vl": TS_WORDING,
  "soundness/nullable-access-unguarded.vl": TS_WORDING,
  "soundness/nullable-chain-unguarded-reject.vl": TS_WORDING,
  "soundness/object-field-value-mismatch-generic.vl": TS_WORDING,
  "soundness/object-field-value-mismatch-inline.vl": TS_WORDING,
  "soundness/object-field-value-mismatch.vl": TS_WORDING,
  "soundness/return-union-unnarrowed-reject.vl": TS_WORDING,
  "soundness/struct-field-type-mismatch-reject.vl": TS_WORDING,
  "soundness/struct-missing-field-reject.vl": TS_WORDING,
  "soundness/struct-union-unshared-field-reject.vl": TS_WORDING,
  "soundness/union-four-variant-missing-reject.vl": TS_WORDING,
  "soundness/union-narrow-reject.vl": TS_WORDING,
  ...
  "types/return-mismatch.vl": TS_WORDING,
