...
// corpus oracle's, `compiler/cli_util.vl` and `scripts/vl-host/src/main.rs`) and
// the test that keeps them agreeing; the two TS ones used to be hand-maintained
// twins and had silently lost the `export { … } from "…"` arm.
