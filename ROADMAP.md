     ...
     **ladder-vs-descriptor agreement oracle** (`repABNote`/`repLadderABSweep`, riding
     ...
     4. 🟡 **The `expr*` family** — 48 classifiers, 931 call sites, 31% of all classifier call
        ...
        **no magic-number rep codes**, and **89% of its rep-ish sites are already `VKind`
        ...
        are `localLitUnion`, the literal-union carve-out. Byte-identical in 3,174 + 7,589, seed
        −368. **And the census's own ranking misleads here**: `exprIsLitAtom` has the most
