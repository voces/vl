...
| 29 | **F-day-one — three grammar axes still absent** | `day-one-sampler.md`: operator overloading, recursive types, mixed-width arithmetic (`match` landed as a `narrowing` spelling, D1885/D1886; multi-param generics as a `pinning` face, D1887/D1888) | `scripts/day-one/grammar.py` | half-day per axis |
