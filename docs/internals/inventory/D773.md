...
a Readable inference and an element-converting copy — are what landed · witness respelled with a `readonly` destination on 2026-09-23, since only a readonly list is covariant ([D2161](D2161.md)); the mutable spelling is refused by design**
