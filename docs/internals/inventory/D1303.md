...
**closed 2026-09-25 — the filed repro RUNS and prints `5` · was check-clean invalid wasm, clause 1 · `type mismatch: expected i32, found i64` · ZERO corpus cells · found 2026-09-03 by [D1220](#d1220)'s 10-destination grid; present on master, and independent of D1220 (whose struct cell TRAPPED where this one never loads)**
