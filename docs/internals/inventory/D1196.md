...
**closed 2026-09-06 by [D1752](D1752.md) — the witness prints `x` · was a loud emit reject,
`emitProgram: only i32 locals are supported` · `vl check` rc 0 · clause 2 · filed 2026-09-02 as
the ONE position of [D1050](#d1050)'s delivery matrix that its close does not reach · the
ANNOTATED face; the un-annotated face of the same line always ran**
