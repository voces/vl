...
**check-clean invalid wasm · found 2026-08-27 as the ENTIRE residue of the D111/D117 grid — 24 of 1,710 cells, unmoved by that change · pre-existing and byte-identical on master `7b600b57` and on the D111/D117 branch, same sentence**
