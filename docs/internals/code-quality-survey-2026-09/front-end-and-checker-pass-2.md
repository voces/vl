...
two live ones are one mechanism, and one scope-keyed alias analysis closes them together --
**landed**: every predicate now keys on (name, frame), 18 of the 82 cells of
