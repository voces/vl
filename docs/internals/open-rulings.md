...
{[K]: boolean}`, still share a tag; that is D2493, now refused at check for every key rep.
...
### dead-null-test — is a null test on a provably non-null value an ERROR or a LINT? — ASKED 2026-09-07
